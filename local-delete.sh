...
echo "delete drupal-dev..."
kubectl delete -f ./kubernetes/drupal-dev.yaml
kubectl delete -f ./kubernetes/drupal-dev-local-pv.yaml
rm -rf /Users/Shared/Kubernetes/persistent-volumes/default/drupal-dev
